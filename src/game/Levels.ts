...
export const LEVELS: LevelDef[] = [
  ...
  // ---------------------------------------------------------------- L8
  {
    ...
    start: [
      ...
      { index: 2, amplitude: 0.5 },
      { index: 3, amplitude: 0.28 },
      { index: 4, amplitude: 0.80, phase: 0.52 },
      { index: 5, amplitude: 0.65, phase: 3.12 },
      { index: 6, amplitude: 0.75, phase: 5.72 },
      { index: 7, amplitude: 0.85, phase: 2.03 },
      { index: 8, amplitude: 0.70, phase: 4.63 },
      { index: 9, amplitude: 0.80, phase: 0.95 },
      { index: 10, amplitude: 0.65, phase: 3.55 },
    ],
    threshold: 0.997,
  },
  ...
  // the high threads so only the mid lanes glow.
  {
    ...
    start: [
      ...
      { index: 4, amplitude: 0.5 },
      { index: 5, amplitude: 0.4 },
      { index: 1, amplitude: 0.75, phase: 1.70 },
      { index: 2, amplitude: 0.85, phase: 4.30 },
      { index: 6, amplitude: 0.75, phase: 5.72 },
      { index: 7, amplitude: 0.85, phase: 2.03 },
      { index: 8, amplitude: 0.70, phase: 4.63 },
      { index: 9, amplitude: 0.80, phase: 0.95 },
  ...
  // the broad, washed-out low band so only the vivid high colours remain.
  {
    ...
    start: [
      ...
      { index: 1, amplitude: 0.75, phase: 1.70 },
      { index: 2, amplitude: 0.85, phase: 4.30 },
      { index: 3, amplitude: 0.70, phase: 0.62 },
      { index: 4, amplitude: 0.80, phase: 3.22 },
      { index: 5, amplitude: 0.65, phase: 5.82 },
      { index: 10, amplitude: 0.65, phase: 2.65 },
    ],
    threshold: 0.993,
  },
  ...
  // denoise model rewards clearing energy that isn't in the target.
  {
    ...
    start: [
      ...
      { index: -1, amplitude: 0.55 },
      { index: 5, amplitude: 0.65 },
      { index: 6, amplitude: 0.75 },
      { index: 7, amplitude: 0.85 },
    ],
    threshold: 0.995,
  },
  ...
  // ---------------------------------------------------------------- L24  (SELECT)
  {
    ...
    start: [
      { index: 1, amplitude: 0.7 },
      { index: 2, amplitude: 0.5 },
      { index: 4, amplitude: 0.4 },
      { index: 3, amplitude: 0.70 },
      { index: 5, amplitude: 0.65 },
      { index: 6, amplitude: 0.75 },
    ],
    threshold: 0.994,
  ...
  // ---------------------------------------------------------------- L25  (SELECT)
  {
    ...
    start: [
      { index: 2, amplitude: 0.6 },
      { index: 3, amplitude: 0.5 },
      { index: 6, amplitude: 0.4 },
      { index: 7, amplitude: 0.3 },
      { index: 1, amplitude: 0.75 },
      { index: 4, amplitude: 0.80 },
      { index: 5, amplitude: 0.65 },
      { index: 8, amplitude: 0.70 },
      { index: 9, amplitude: 0.80 },
    ],
    threshold: 0.994,
  },
  ...
  // ---------------------------------------------------------------- L26  (SELECT, band)
  {
    ...
    start: [
      { index: 4, amplitude: 0.6 },
      { index: 5, amplitude: 0.5 },
      { index: 1, amplitude: 0.75 },
      { index: 2, amplitude: 0.85 },
      { index: 3, amplitude: 0.70 },
      { index: 6, amplitude: 0.75 },
      { index: 7, amplitude: 0.85 },
      { index: 8, amplitude: 0.70 },
  ...
  // ---------------------------------------------------------------- L27  (calm)
  {
    ...
    start: [
      { index: 1, amplitude: 0.9 },
      { index: 2, amplitude: 0.5 },
      { index: 3, amplitude: 0.70, phase: 5.10 },
      { index: 4, amplitude: 0.80, phase: 1.42 },
      { index: 5, amplitude: 0.65, phase: 4.02 },
      { index: 6, amplitude: 0.75, phase: 0.33 },
      { index: 7, amplitude: 0.85, phase: 2.93 },
      { index: 8, amplitude: 0.70, phase: 5.53 },
      { index: 9, amplitude: 0.80, phase: 1.85 },
    ],
    threshold: 0.997,
  },
