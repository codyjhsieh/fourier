...
export const LEVELS: LevelDef[] = [
  ...
  // ---------------------------------------------------------------- L3
  {
    ...
    target: [
      ...
      { index: 3, amplitude: 0.4, phase: Math.PI },
      { index: 4, amplitude: 0.3, phase: -Math.PI / 2 },
    ],
    // correct amplitudes, scrambled phases — the gate is twisted
    start: [
      { index: 1, amplitude: 0.9, phase: 2.4 },
      { index: 2, amplitude: 0.6, phase: 4.1 },
      { index: 3, amplitude: 0.4, phase: 0.7 },
      { index: 4, amplitude: 0.3, phase: 1.9 },
    ],
    threshold: 0.9,
  },
  ...
  // ---------------------------------------------------------------- L4
  {
    ...
    target: [
      ...
      { index: 6, amplitude: 0.22, phase: 2.5 },
    ],
